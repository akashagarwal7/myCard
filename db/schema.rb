...
ActiveRecord::Schema.define(version: 20180909011209) do
  ...
  create_table "mykis", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["number"], name: "index_mykis_on_number", unique: true
    t.index ["user_id"], name: "index_mykis_on_user_id", unique: true
  end
  ...
  create_table "passports", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_passports_on_user_id", unique: true
  end
