...
class PassportsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create passport" do
    assert_difference('Passport.count') do
      post passports_url, params: { passport: { number: @passport.number, user_id: @passport.user_id } }
    end
  ...
  test "should update passport" do
    patch passport_url(@passport), params: { passport: { number: @passport.number, user_id: @passport.user_id } }
